...
const headerNavToggleButtonElem = bodyElem.querySelector(
  ".header-nav-toggle-button-js",
);

const headerThemeInputElems = bodyElem.querySelectorAll(
  ".header-theme-input-js",
);
let colorTheme;
